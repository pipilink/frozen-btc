...
async function main() {
  ...
  console.log('Holder balance',await frozenBitcoinContract.balanceOf("0xf93Cda5C985933EA3Edb40ddefE3169d3Cb28cBF")/10**8,'FBTC')
  console.log('Owner BALANCE:',await ethers.provider.getBalance(await frozenBitcoinContract.owner())/10**18, 'ETH')
  console.log('NFT CONTRACT BALANCE:',await ethers.provider.getBalance("0x5FbDB2315678afecb367f032d93F642f64180aa3")/10**18, 'ETH')
