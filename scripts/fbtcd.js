...
const FBTCDeposit = require('../artifacts/contracts/nft-fbtc.sol/FBTCDeposit.json')

async function main() {
  const [caller,signer] = await ethers.getSigners()
  const fbtcDepositAddr = '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512'
...
*/
  ...
  const fbtcDepositContract = new ethers.Contract(
    fbtcDepositAddr,
    FBTCDeposit.abi,
    caller
  )
  ...
  console.log('owner',await fbtcDepositContract.owner())
/*
...
*/
  ...
  ],"0x3e45dceef5f0d576112db1ff22cbcfce4a32c9edfca80f653ea7385eebe01d5010a9160cf95b30043c851c292211aa02a595c061b3a7be2b147611f815cc3f021b"
  // "0x3e45dceef5f0d576112db1ff22cbcfce4a32c9edfca80f653ea7385eebe01d5010a9160cf95b30043c851c292211aa02a595c061b3a7be2b147611f815cc3f021b"
...
[15000000000000000000],["1KNm4K8GUK8sMoxc2Z3zU8Uv5ABC100"],[1000000000000000],[0],[500000000000],[100],"0x3e45dceef5f0d576112db1ff22cbcfce4a32c9edfca80f653ea7385eebe01d5010a9160cf95b30043c851c292211aa02a595c061b3a7be2b147611f815cc3f021b"
...
*/
 ...
 console.log( await fbtcDepositContract.safeMint(signer.address,"5816") );
...
npx hardhat run .\scripts\frozen-btc.js --network localhost
